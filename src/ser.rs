...
//! [`Serializer`], which are the homonymous and dyn-compatible version
//! of [`serde::Serialize`] and [`serde::Serializer`].
//!
//! See the documentation of [`Serialize`] and [`Serializer`] for more details.
...
/// The dyn-compatible version of the homonymous trait [`serde::Serialize`].
///
...
pub trait Serialize {
    ...
    /// been consumed.
    fn serialize_dyn(&self, serializer: &mut dyn Serializer) -> Result<()>;
}

/// The dyn-compatible version of the homonymous trait [`serde::Serializer`].
///
/// # Example
///
/// To construct dynamic serializer, consider using `<dyn Serializer>::new`
...
/// // Constructs dynamic serializer with `<dyn Serializer>::new`.
/// let serializer = <dyn Serializer>::new(&mut serializer);
/// // Converts into boxed trait object.
...
pub trait Serializer {
    ...
    fn serialize_bool_dyn(&mut self, v: bool) -> Result<()>;

    /// Serializes an `i8` value.
    fn serialize_i8_dyn(&mut self, v: i8) -> Result<()>;

    /// Serializes an `i16` value.
    fn serialize_i16_dyn(&mut self, v: i16) -> Result<()>;

    /// Serializes an `i32` value.
    fn serialize_i32_dyn(&mut self, v: i32) -> Result<()>;

    /// Serializes an `i64` value.
    fn serialize_i64_dyn(&mut self, v: i64) -> Result<()>;

    /// Serializes an `i128` value.
    fn serialize_i128_dyn(&mut self, v: i128) -> Result<()>;

    /// Serializes a `u8` value.
    fn serialize_u8_dyn(&mut self, v: u8) -> Result<()>;

    /// Serializes a `u16` value.
    fn serialize_u16_dyn(&mut self, v: u16) -> Result<()>;

    /// Serializes a `u32` value.
    fn serialize_u32_dyn(&mut self, v: u32) -> Result<()>;

    /// Serializes a `u64` value.
    fn serialize_u64_dyn(&mut self, v: u64) -> Result<()>;

    /// Serializes a `u128` value.
    fn serialize_u128_dyn(&mut self, v: u128) -> Result<()>;

    /// Serializes an `f32` value.
    fn serialize_f32_dyn(&mut self, v: f32) -> Result<()>;

    /// Serializes an `f64` value.
    fn serialize_f64_dyn(&mut self, v: f64) -> Result<()>;

    /// Serializes a character.
    fn serialize_char_dyn(&mut self, v: char) -> Result<()>;

    /// Serializes a string slice.
    fn serialize_str_dyn(&mut self, v: &str) -> Result<()>;

    /// Serializes a byte slice.
    fn serialize_bytes_dyn(&mut self, v: &[u8]) -> Result<()>;

    /// Serializes an optional value that is absent.
    fn serialize_none_dyn(&mut self) -> Result<()>;

    /// Serializes an optional value that is present.
    fn serialize_some_dyn(&mut self, value: &dyn Serialize) -> Result<()>;

    /// Serializes a unit value.
    fn serialize_unit_dyn(&mut self) -> Result<()>;

    /// Serializes a unit struct.
    fn serialize_unit_struct_dyn(&mut self, name: &'static str) -> Result<()>;
    ...
    fn serialize_seq_dyn(&mut self, len: Option<usize>) -> Result<()>;

    /// Begins to serialize a statically sized sequence.
    fn serialize_tuple_dyn(&mut self, len: usize) -> Result<()>;

    /// Begins to serialize a tuple struct.
    fn serialize_tuple_struct_dyn(&mut self, name: &'static str, len: usize) -> Result<()>;
    ...
    fn serialize_map_dyn(&mut self, len: Option<usize>) -> Result<()>;

    /// Begins to serialize a struct.
    fn serialize_struct_dyn(&mut self, name: &'static str, len: usize) -> Result<()>;
    ...
    fn collect_str_dyn(&mut self, value: &dyn Display) -> Result<()>;
    ...
    fn seq_serialize_element_dyn(&mut self, value: &dyn Serialize) -> Result<()>;

    /// Finishes serializing a sequence.
    fn seq_end_dyn(&mut self) -> Result<()>;

    /// Serializes a tuple element.
    fn tuple_serialize_element_dyn(&mut self, value: &dyn Serialize) -> Result<()>;

    /// Finishes serializing a tuple.
    fn tuple_end_dyn(&mut self) -> Result<()>;

    /// Serializes a tuple struct field.
    fn tuple_struct_serialize_field_dyn(&mut self, value: &dyn Serialize) -> Result<()>;

    /// Finishes serializing a tuple struct.
    fn tuple_struct_end_dyn(&mut self) -> Result<()>;

    /// Serializes a tuple variant field.
    fn tuple_variant_serialize_field_dyn(&mut self, value: &dyn Serialize) -> Result<()>;

    /// Finishes serializing a tuple variant.
    fn tuple_variant_end_dyn(&mut self) -> Result<()>;

    /// Serializes a map key.
    fn map_serialize_key_dyn(&mut self, key: &dyn Serialize) -> Result<()>;

    /// Serializes a map value.
    fn map_serialize_value_dyn(&mut self, value: &dyn Serialize) -> Result<()>;

    /// Serializes a map entry consisting of a key and a value.
    fn map_serialize_entry_dyn(&mut self, k: &dyn Serialize, v: &dyn Serialize) -> Result<()>;
    ...
    fn map_end_dyn(&mut self) -> Result<()>;
    ...
    fn struct_skip_field_dyn(&mut self, key: &'static str) -> Result<()>;

    /// Finishes serializing a struct.
    fn struct_end_dyn(&mut self) -> Result<()>;
    ...
    fn struct_variant_skip_field_dyn(&mut self, key: &'static str) -> Result<()>;

    /// Finishes serializing a struct variant.
    fn struct_variant_end_dyn(&mut self) -> Result<()>;
}
...
impl<S: serde::Serializer> Serializer for MakeSerializer<S> {
    fn serialize_bool_dyn(&mut self, v: bool) -> Result<()> {
        if let MakeSerializer::Serializer(ser) = core::mem::take(self) {
    ...
    fn collect_str_dyn(&mut self, value: &dyn core::fmt::Display) -> Result<()> {
        if let MakeSerializer::Serializer(ser) = core::mem::take(self) {
    ...
    fn seq_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeSeq(ser) = core::mem::take(self) {
    ...
    fn tuple_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeTuple(ser) = core::mem::take(self) {
    ...
    fn tuple_struct_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeTupleStruct(ser) = core::mem::take(self) {
    ...
    fn tuple_variant_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeTupleVariant(ser) = core::mem::take(self) {
    ...
    fn map_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeMap(ser) = core::mem::take(self) {
    ...
    fn struct_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeStruct(ser) = core::mem::take(self) {
    ...
    fn struct_variant_end_dyn(&mut self) -> Result<()> {
        if let MakeSerializer::SerializeStructVariant(ser) = core::mem::take(self) {
...
impl serde::Serialize for dyn Serialize + '_ {
        ...
        S: serde::Serializer,
    {
        ...
        match self.serialize_dyn(&mut serializer) {
            // SAFETY: The march arm guarantees that `self.serialize_dyn(_)`
            // has succeeded, thus `serializer` is supposed to be
            // `MakeSerializer::Value(_)`.
            Ok(()) => Ok(unsafe { serializer.expect().unwrap_unchecked() }),
